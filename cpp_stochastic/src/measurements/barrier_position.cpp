...
void BarrierPosition::initialize(const filaments::container_t &filaments,
...
std::vector<double> BarrierPosition::get_times() const {
...
std::vector<double> BarrierPosition::get_means() const {
    return _values;
}

std::vector<double> BarrierPosition::get_errors(
