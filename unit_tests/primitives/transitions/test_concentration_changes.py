...
class ConcentrationChangeTest(unittest.TestCase):
    ...
    def test_normal_rates(self):
        self.assertEqual(self.normal_one.R(None, None, self.concentrations), [30])
        self.assertEqual(self.normal_two.R(None, None, self.concentrations), [40])

    def test_missing_rates(self):
        self.assertEqual(self.missing.R(None, None, self.concentrations), [0])
