...
TEST_F(TipHydrolysisTest, BETipHydrolysis) {
    transitions::BarbedEndTipHydrolysis be_12(one, two, 3);
...
TEST_F(TipHydrolysisTest, PETipHydrolysis) {
    transitions::PointedEndTipHydrolysis pe_12(one, two, 3);
...
TEST_F(TipHydrolysisTest, BETipHydrolysisWB) {
    transitions::BarbedEndTipHydrolysisWithByproduct be_12(one, two, 3, three);
...
TEST_F(TipHydrolysisTest, PETipHydrolysisWB) {
    transitions::PointedEndTipHydrolysisWithByproduct pe_12(one, two, 3, three);
